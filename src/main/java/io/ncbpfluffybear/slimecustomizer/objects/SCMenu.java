...
public class SCMenu extends ChestMenu {
    ...
    public void addBackButton(SurvivalSlimefunGuide guide, Player p, PlayerProfile profile) {
        ...
        if (history.size() > 1) {
            this.replaceExistingItem(BACK_BUTTON_SLOT, new CustomItemStack(ChestMenuUtils.getBackButton(p, "", "&fLeft Click: &7Go back", "&fShift + Left Click: &7Back to main menu")));
